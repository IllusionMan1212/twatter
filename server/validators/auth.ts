...
export const VerifyResetPasswordTokenData = z.object({
...
export const RevokeSessionData = z.object({
    deviceId: z.string({ required_error: "deviceId is required" }).min(1, "Device ID cannot be empty"),
});
